...
export default function VendorDashboard() {
  ...
  const totalRevenue = vendorOrders.reduce((sum, o) => sum + o.paidAmount, 0);
  const activeRentals = vendorOrders.filter((o) => o.status === 'picked_up');
  const overdueReturns = vendorOrders.filter(
    (o) => o.status === 'picked_up' && o.returnDate && new Date(o.returnDate) < new Date()
  );
