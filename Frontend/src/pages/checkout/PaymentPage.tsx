...
import { ChevronLeft, CreditCard, Wallet, Building, Smartphone, CheckCircle } from 'lucide-react';
...
export default function PaymentPage() {
  ...
  useEffect(() => {
    // Get delivery cost from localStorage
    const deliveryInfo = localStorage.getItem('checkoutDeliveryType');
    if (deliveryInfo) {
      const parsed = JSON.parse(deliveryInfo);
      if (parsed.type === 'shipping' && parsed.shippingSlot) {
        setDeliveryCost(parsed.shippingSlot.cost || 0);
      }
    }
  }, []);
  ...
  const handlePlaceOrder = async () => {
    ...
    setTimeout(() => {
      ...
      localStorage.removeItem('checkoutContactDetails');
            ...
            <div>
              ...
              >
                <div className="mb-6 flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold">4. Payment Method</h2>
                ...
                <div className="space-y-6">
                      ...
                      {paymentMethods.map((method) => (
                        ...
                        >
                          <div className="flex items-center gap-4 p-4">
                            ...
                            >
                              <div className="mb-1 font-semibold">{method.name}</div>
                  ...
                  <div className="rounded-xl bg-green-50 p-4">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <h4 className="font-semibold text-green-900">Safe & Secure Payment</h4>
                    </div>
                  ...
                  <div className="flex items-start gap-3 rounded-xl border border-border p-4">
                    ...
                    <Label htmlFor="terms" className="cursor-pointer text-sm">
                      ...
                      . I understand that rental items must be returned in good condition and by
                      the specified date.
                    </Label>
                  </div>
